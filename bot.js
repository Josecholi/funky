...
var disconnected;
DiscordClient.login('NTE1NjU3MjU3NjkwNTk1MzI4.Du7kYQ.pnN-lleUORyzsGrl7Vjf0FZ_a74'); //bot token
...
setInterval(function() {
  if(typeof owopbot.chat == "string") {
       var channel = DiscordClient.channels.get("521378443019943969");
...
function status2() {
  try{
  DiscordClient.user.setActivity("Filthy animals", {type: "STREAMING"}); //funny message
  } catch(e) {
    console.log(e)
  }
